package us.kbase.mergemetabolicannotations;
...
public class MergeMetabolicAnnotationsClient {
    ...
    public Map<String, Object> status(RpcContext... jsonRpcContext) throws IOException, JsonClientException {
        ...
        List<Map<String, Object>> res = caller.jsonrpcCall("MergeMetabolicAnnotations.status", args, retType, true, false, jsonRpcContext, this.serviceVersion);
        return res.get(0);
    }
}
