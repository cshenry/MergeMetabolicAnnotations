...
def get_config():
    ...
    for nameval in config.items(get_service_name() or 'MergeMetabolicAnnotations'):
        retconfig[nameval[0]] = nameval[1]
    return retconfig

config = get_config()

from MergeMetabolicAnnotations.MergeMetabolicAnnotationsImpl import MergeMetabolicAnnotations  # noqa @IgnorePep8
impl_MergeMetabolicAnnotations = MergeMetabolicAnnotations(config)
